...
const Producers = ({ animeProducers, animeId }: { animeProducers: Producer[], animeId: number}) => {
    return (
        <div className='producers pb-16 mb-8'>
            ...
            {
                animeProducers.map((item: Producer) => <ProducerImage key={item.mal_id} prodId={item.mal_id} animeId={animeId} />)  
