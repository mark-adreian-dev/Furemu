  ...
  return (
    <div className="main-content px-6 mt-24 pt-8 flex flex-col items-center tablet:pt-16 tablet:px-16">
      ...
      <div className="relative w-full tablet:w-full">
        <h1 className="text-accent text-center text-3xl font-bold mb-32 tablet:text-6xl tablet:w-[28.875rem] tablet:mx-auto">{!data.title_english ? data.title : data.title_english}</h1>
