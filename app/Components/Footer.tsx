  ...
  return (
    <footer>
        ...
        <div className="socials">
          <div className="page-navigation flex justify-center items-start">
            <div className="navigation mr-16">
              <p className="title text-center font-semibold text-sm text text-white opacity-60 mb-2">
                Navigation
              </p>
                  ...
                  {menu.map((item) => (
                    <li key={item.menuTitle} className="item">
                      <Link
                        ...
                        className={`text-white font-medium ${item.menuTitle !== "Manga" && "mb-2"} hover:!text-accent`}
                        scroll={false}
                      >
                        {item.menuTitle}
                      </Link>
            ...
            <div className="socials">
              ...
              <nav className="text-center menu">
                <ul className="flex flex-col justify-center items-center tablet:items-center">
                  {socials.map((item) => (
                    <li key={item.menuTitle} className="item">
                      <Link
                        href={item.destination}
      ...
      <div className="disclaimer bg-darker-blue px-6 py-2">
        <p className="text-accent font-semibold text-xs text-center tablet:text-sm tablet:px-16">
